  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <header style={{
        ...
        <span style={{ fontSize: 12, color: 'var(--text-dim)', fontFamily: 'var(--font-data)', marginLeft: 8 }}>
          Live Market Data
        </span>
      </header>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ marginBottom: 40, textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: 16, marginBottom: 28 }}>
            Real-time prices, charts, and key metrics from Yahoo Finance.
          </p>
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '60px 0', color: 'var(--text-dim)' }}>
            ...
            <p style={{ marginTop: 16, fontFamily: 'var(--font-data)', fontSize: 14 }}>
        ...
        {!stockData && !loading && !error && (
          <div style={{
            ...
            <p style={{ fontFamily: 'var(--font-data)', fontSize: 14 }}>
